...
function safeDateFormat(date, _ref2) {
  ...
  return date && date.clone && date.clone().locale(locale || moment.locale()).format(Array.isArray(dateFormat) ? dateFormat[0] : dateFormat) || "";
}
...
var DatePicker = function (_React$Component) {
  ...
  function DatePicker(props) {
    ...
    _this.renderDateInput = function () {
      ...
      var className = classnames((_this.props.className || '') + ' input', (_classnames = {}, _classnames[outsideClickIgnoreClass] = _this.state.open, _classnames));

      var customInput = _this.props.customInput || React.createElement("input", { type: "text",placeholder: _this.props.placeholder || 'Please select date'});
